...
@dataclass(frozen=True)
class FieldReconstructionFitReport:
...
@dataclass(frozen=True)
class FieldReconstructionTrace:
    tokens: int
...
@dataclass(frozen=True)
class FieldReconstructionReport:
    tokens: int
    steps: int
...
class FieldReconstructionModel:
    def __init__(
        self,
        config: FieldReconstructionConfig | None = None,
        *,
    ...
    def fit(
        ...
        return FieldReconstructionFitReport(
            forward=forward,
            reverse=reverse,
    ...
    def _distributions_for_position(self, tokens: np.ndarray, position: int) -> tuple[np.ndarray, np.ndarray, np.ndarray]:
    ...
    def trace(
        ...
        return FieldReconstructionTrace(
            tokens=int(tokens.size),
    ...
    def score(
        ...
        return FieldReconstructionReport(
            tokens=trace.tokens,
            steps=trace.steps,
